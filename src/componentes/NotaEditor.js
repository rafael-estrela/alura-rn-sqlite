...
import { createNote, deleteNote, updateNote } from "../servicos/notas"

export default function NotaEditor({ showNotes, notaSelecionada, setNotaSelecionada }) {
  ...
  const removeNote = async () => {
    const result = await deleteNote(notaSelecionada.id)
    console.log(result)
    limpaModal()
    await showNotes()
  }
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={estilos.modal}>
              ...
              <View style={estilos.modalPicker}>
                <Picker selectedValue={categoria} onValueChange={item => setCategoria(item)}>
              ...
              <View style={estilos.modalBotoes}>
                <TouchableOpacity style={estilos.modalBotaoSalvar} onPress={() => notaParaAtualizar ? alterNote() : saveNote()}>
                  <Text style={estilos.modalBotaoTexto}>Salvar</Text>
                </TouchableOpacity>
                {notaParaAtualizar && <TouchableOpacity style={estilos.modalBotaoDeletar} onPress={() => removeNote()}>
